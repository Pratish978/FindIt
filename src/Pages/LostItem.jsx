            ...
            {filteredItems.map((item) => (
              <div key={item._id} className="bg-white rounded-[2.5rem] overflow-hidden shadow-xl border border-slate-50 flex flex-col group hover:shadow-2xl transition-all duration-500">
                ...
                <div className="p-8 flex-1 flex flex-col">
                  ...
                  <button onClick={() => {setSelectedItem(item); setVerificationError(false);}} className="mt-auto w-full py-4 bg-slate-900 text-white rounded-2xl font-black uppercase text-xs flex items-center justify-center gap-3 hover:bg-blue-600 transition-all shadow-lg shadow-slate-100">
