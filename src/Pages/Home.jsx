...
const Home = () => {
  ...
  useEffect(() => {
    fetch('http://localhost:5000/api/items/all')
      ...
      .then(data => {
        ...
        // Show only the 3 most recent stories to keep the section small
  ...
  return (
    <div className="overflow-x-hidden bg-[#f8fafc]">
      ...
      {/* 2. Compact Feedback Section (Now below Recent Items) */}
      {stories.length > 0 && (
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {stories.map((story) => (
              ...
              >
                ...
                <p className="text-slate-600 text-sm italic mb-6 leading-relaxed relative z-10">
                  "{story.feedback}"
                </p>
